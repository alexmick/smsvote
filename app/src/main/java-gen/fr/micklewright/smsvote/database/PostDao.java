...
public class PostDao extends AbstractDao<Post, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Places = new Property(2, Integer.class, "places", false, "PLACES");
        public final static Property ElectionId = new Property(3, long.class, "electionId", false, "ELECTION_ID");
    };

    private DaoSession daoSession;

    private Query<Post> election_PostsQuery;
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'POST' (" + //
                ...
                "'NAME' TEXT," + // 1: name
                "'PLACES' INTEGER," + // 2: places
                "'ELECTION_ID' INTEGER NOT NULL );"); // 3: electionId
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Post entity) {
        ...
        Integer places = entity.getPlaces();
        if (places != null) {
            stmt.bindLong(3, places);
        }
        stmt.bindLong(4, entity.getElectionId());
    }
    ...
    public Post readEntity(Cursor cursor, int offset) {
        Post entity = new Post( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getInt(offset + 2), // places
            cursor.getLong(offset + 3) // electionId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Post entity, int offset) {
        ...
        entity.setPlaces(cursor.isNull(offset + 2) ? null : cursor.getInt(offset + 2));
        entity.setElectionId(cursor.getLong(offset + 3));
     }
    ...
    /** Internal query to resolve the "posts" to-many relationship of Election. */
    public List<Post> _queryElection_Posts(long electionId) {
        synchronized (this) {
            if (election_PostsQuery == null) {
                QueryBuilder<Post> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.ElectionId.eq(null));
                election_PostsQuery = queryBuilder.build();
            }
        }
        Query<Post> query = election_PostsQuery.forCurrentThread();
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(',');
            SqlUtils.appendColumns(builder, "T0", daoSession.getElectionDao().getAllColumns());
            builder.append(" FROM POST T");
            builder.append(" LEFT JOIN ELECTION T0 ON T.'ELECTION_ID'=T0.'_id'");
            builder.append(' ');
