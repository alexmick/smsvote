...
public class ApplicationDao extends AbstractDao<Application, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property ApplicantId = new Property(2, long.class, "applicantId", false, "APPLICANT_ID");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'APPLICATION' (" + //
                ...
                "'POST_ID' INTEGER NOT NULL ," + // 1: postId
                "'APPLICANT_ID' INTEGER NOT NULL );"); // 2: applicantId
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Application entity) {
        ...
        stmt.bindLong(2, entity.getPostId());
        stmt.bindLong(3, entity.getApplicantId());
    }
    ...
    public Application readEntity(Cursor cursor, int offset) {
        Application entity = new Application( //
            ...
            cursor.getLong(offset + 1), // postId
            cursor.getLong(offset + 2) // applicantId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Application entity, int offset) {
        ...
        entity.setPostId(cursor.getLong(offset + 1));
        entity.setApplicantId(cursor.getLong(offset + 2));
     }
